...
const FILES = [
    ...
    'AppNuestrosArticulos.html', 'AppNuestrosArticulos.js',
    'AppCategoriaArticulo.js',
    'AppCategoriasInventario.html',
    'AppCategoriasCompra.html',
    'AppCategoriasAlmacenamiento.html',
    'AppCategoriasRotacion.html',
    'AppCategoriasManejoEspecial.html',
    'AppCategoriasRiesgo.html',
    'AppCategoriasVidaUtil.html',
    'AppUnidadMedida.html',
    'AppCotizaciones.html', 'AppCotizaciones.js',
    'AppTraslados.html', 'AppTraslados.js',
    'manifest.json', 'sw.js',
